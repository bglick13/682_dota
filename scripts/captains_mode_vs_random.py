...
if __name__ == '__main__':
    model: DraftBert = torch.load('../weights/final_weights/draft_bert_pretrain_captains_mode.torch',
    ...
    with open('../data/self_play/captains_mode_vs_random_memory.pickle', 'wb') as f:
